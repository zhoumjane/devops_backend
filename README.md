This project aims to provide a back-end API interface. The front-end needs to be implemented by the user. The front-end code is not provided temporarily. Please solve it by yourself!
